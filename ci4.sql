...
--
-- Host: localhost:8889
-- Generation Time: Dec 15, 2023 at 04:50 AM
...
(4, 'www.inmr.com', 'www.inmr.com', NULL),
(5, 'Greg Freeman', NULL, NULL),
(6, 'John Sims', NULL, NULL),
(7, 'www.dynamicratings.com', NULL, NULL);
...
(15, '2023-12-15-034519', 'App\\Database\\Migrations\\AddForeignRestraintOnPosts', 'default', 'App', 1702612101, 14);
...
(25, 'latest-power-outage-statistics-and-causes-tracker', 'Latest Power Outage Statistics and Causes Tracker', '<p>As the world’s technological landscape continues to grow and the demand for electricity increases, so too do the occurrences of power outages. Check out Critter Guard’s curated list where we track power outages statistics and data below or check out our power outages infographic.</p>\r\n\r\n<p>Power Outages’ Impact on Homeowners and Businesses Statistics\r\nCollectively, utility customers experienced 1.33 billion outage hours in 2020. (SP Global)\r\nThe decade from 2011-2021 experienced 64% more major power outages than that from 2000-2010. (Climate Central)\r\nThe average American experienced just over eight hours of power outages in 2020. (EIA)\r\nA 2018 survey found that one in four companies experience a power outage at least once a month. (Bloom Energy)</p>\r\n\r\n<p>Animal-Related Power Outage Statistics\r\nPower outages around the globe are caused by a multitude of factors such as severe weather, transmission overload, human error, and animal interference. While a lot of power outages result from severe weather, animal related power outages are common cause of a tremendous number of power outages each year both in the US and nationwide. In fact, animal interference is the second leading cause of power outages in the US. Check out these animal-related power outages statistics below:\r\nSquirrels and other wildlife are the most common cause of outages at public power utilities. (American Public Power Association, April 2016)\r\nAbout 13 million Americans lose power to wildlife annually. (The Nature Conservancy)\r\nIn 2019, squirrels caused more than 15,000 animal-related power outages. (Entergy)\r\nOn average, 48% of outages caused by squirrels and other wildlife occur during the months of May, June, and October. (Unitil)\r\nIn March 2022, a bird that flew into an electrical substation was blamed for taking out power for nearly 10,000 customers in New Orleans, LA. (NY Times)\r\nIn 2016, a weasel was the cause of a shutdown of Europe’s Large Hadron Collider. (BBC)</p>', 1, 0, 'https://www.electricity-today.com/wp-content/uploads/magazine_may_june_2023_article_2.jpg', '2023-12-14 19:43:57', '2023-12-14 19:43:57', 6, NULL),
(26, 'case-study-rapid-changes-in-bushing-health', 'Case Study: Rapid Changes in Bushing Health', '<p>Introduction<br>\r\nContinuous online monitoring of bushings provides real-time information which can result in the early detection of a possible failure. </p>\r\n<p>Challenge: A Major Alarm<br>\r\nA prominent U.S. utility was looking for a way to improve system reliability for their 138kV assets. They researched and reviewed options available on the market that included affordable bushing monitoring. After review, the utility chose to pilot the Dynamic Ratings’ C50 Transformer Monitor to see if it was worth the investment to become part of the overall solution.<br>\r\nThe C50 Transformer Monitors were installed and serviced on the transformers by Dynamic Ratings Field Engineers. One day, after about two years in service, the utility received notification of a major alarm happening at one of the C50 installation sites. Upon further review of the online web pages, the C50 indicated that there was a rapid change happening in the health of a bushing on the transformer. </p>\r\n<p>To learn more about the C50 Transformer Monitor, visit our website at www.dynamicratings.com/c50</p>\r\n<p><span id=\"more-5895\"></span><br>\r\n<a href=\"https://www.electricityforum.com/et-login.php?url=https://online.electricity-today.com/electricity-today/mayjune-2023/~6\" rel=\"noopener\" target=\"_blank\">Read full article in the Electricity Today T&amp;D Magazine – Substation Automation Protection &amp; Maintenance Edition 2023</a><br>\r\n<a href=\"https://www.electricity-today.com/visit-our-advertisers?advertiser=magazine_may_jun_2023_doble_page_2_1062w.jpg\" rel=\"noopener\" target=\"_blank\">Doble advertisement in the magazine may-jun 2023 page 2</a><br>\r\n<a href=\"https://www.electricity-today.com/visit-our-advertisers?advertiser=magazine_may_jun_2023_doble_page_3_1062w.jpg\" rel=\"noopener\" target=\"_blank\">Doble advertisement in the magazine may-jun 2023 page 3</a></p>', 1, 0, 'https://www.electricity-today.com/wp-content/uploads/magazine_may_june_2023_article_1.jpg', '2023-12-14 19:52:20', '2023-12-14 19:52:20', 7, NULL);
...
(12, 25, 'td-automation', 'T&D Automation', '2023-12-12 05:18:54', '2023-12-12 05:18:55'),
(13, 26, 'td-automation', 'T&D Automation', '2023-12-12 05:18:54', '2023-12-12 05:18:55');
...
--
ALTER TABLE `post`
  ADD CONSTRAINT `fk_author_id` FOREIGN KEY (`author_id`) REFERENCES `author` (`id`) ON UPDATE CASCADE;
