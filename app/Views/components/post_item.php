        ...
        <div class="td_module_2 td_module_wrap td-animation-stack">
            <div class="td-module-image">
                <div class="td-module-thumb">
                    <a href=<?= "https://www.electricity-today.com/uncategorized/" . $post['slug'] ?> rel="bookmark" 
                    title="<?= $post['title'] ?>">
                    <img width="324" height="160" class="entry-thumb td-animation-stack-type0-2" src=<?= $post['image'] ?>  alt="" title=<?= $post['image'] ?> ></a>
                </div>
            </div>
            <h3 class="entry-title td-module-title"><a href=<?= "https://www.electricity-today.com/uncategorized/" . $post['slug'] ?> rel="bookmark" title="Hydrogen Monitoring in the Transformer Headspace Compared to Traditional In-Oil Monitoring">Hydrogen Monitoring in the Transformer Headspace Compared to Traditional In-Oil Monitoring</a></h3>
            ...
            <div class="td-post-author-name"><a href="https://www.electricity-today.com/author/chris-rutledge"><?= $post['author_name'] ?></a></div>
                <div class="td-module-comments">
                    <a href=<?= "https://www.electricity-today.com/uncategorized/" . $post['slug'] . "#"  . "respond" ?>><?= $post['comment_count'] ?></a>
                </div>
            </div>
